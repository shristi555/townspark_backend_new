...
class NotificationReadView(generics.UpdateAPIView):
    ...
    def update(self, request, *args, **kwargs):
        ...
        instance.save()
        return Response(status=status.HTTP_200_OK, data=NotificationSerializer(instance).data)
...
class NotificationMarkAllReadView(APIView):
    ...
    def put(self, request, *args, **kwargs):
        ...
        return Response(status=status.HTTP_200_OK, data={"message": "All notifications marked as read"})
